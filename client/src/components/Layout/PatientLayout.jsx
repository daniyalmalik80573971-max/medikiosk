...
import {
  ...
  User, LogOut, Heart, Bell, Menu, X, Activity
} from 'lucide-react';
...
export default function PatientLayout({ children }) {
  ...
  const navItems = [
    ...
    { href: '/patient/new-case', icon: PlusCircle, label: 'New Case' },
    { href: '/patient/cases', icon: Activity, label: 'My Cases' },
      ...
      <aside className={`fixed top-0 left-0 h-full w-64 bg-white border-r border-gray-200 z-30 transition-transform duration-300 ${
        ...
        <div className="p-6 border-b border-gray-100">
          <Link to="/patient/dashboard" className="flex items-center gap-2">
            ...
            <div>
              <div className="font-bold text-blue-700">MediKiosk</div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-200 px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="lg:hidden flex items-center gap-2">
            ...
            <span className="font-bold text-blue-700">MediKiosk</span>
          </div>
